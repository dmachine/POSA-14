...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
            ...
            startService(DownloadIntentService.makeIntent(DownloadActivity.this, handler, getUrlString()));
        ...
        case R.id.thread_pool_button:
        	...
        	startService(ThreadPoolDownloadService.makeIntent(DownloadActivity.this, handler, getUrlString()));
